...
const fetchTeamsStart = (state, action) => ({ ...state, error: null, loading: true });

const fetchTeamsSuccess = (state, action) => ({
  ...state, teams: action.teams, error: null, loading: false,
});

const fetchTeamsFail = (state, action) => ({ ...state, error: action.error, loading: false });
