import { USER_REAUTH_SUCCESS, REMOVE_USER, FETCH_USER_STATS_START, FETCH_USER_STATS_SUCCESS, FETCH_USER_STATS_FAILURE } from '../actions/types';
...
const userStatsFetchStart = (state, action) => {
    return { ...state, error: null, loading: true };
};

const userStatsFetchSuccess = (state, action) => {
    return { ...state, stats: action.userStats, error: null, loading: false };
};

const userStatsFetchFail = (state, action) => {
